...
export function create(top,left){
    ...
    for (let i = 1; i<6; i++){
        ...
        text.create(characterInfoFormFieldIds[i]+"Text", characterInfotextContents[i], 63 + i%2 * 29, 272 + i%3 * 110, 100, 8, "statsPage", "Scalasanslight", undefined, undefined, "left")
    }
